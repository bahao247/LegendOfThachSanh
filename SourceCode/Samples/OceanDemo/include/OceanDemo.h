...
| Note       : ....................................                                
---------------------------------------------------------------------------------------
| Create File: 21:32:41 15/10/2016 by bahao                                                             
---------------------------------------------------------------------------------------
| Last Update: 21:32:41 15/10/2016 by bahao                                                             
---------------------------------------------------------------------------------------
*/

#ifndef _Game_Ocean_H_
#define _Game_Ocean_H_
...
class _OgreGameClassExport Game_Ocean : public SdkGame
{
public:
	Game_Ocean();
protected:
...
Game_Ocean::Game_Ocean()
{
	mInfo["Title"] = "Level 2";
	mInfo["Description"] = "Cut python.";
	mInfo["Thumbnail"] = "thumb_level2.png";
	mInfo["Category"] = "Easy";
...
/*************************************************************************
	                    Game_Ocean Methods
*************************************************************************/
void Game_Ocean::cleanupContent()
{
...
//--------------------------------------------------------------------------
void Game_Ocean::setupContent(void)
{
...
//--------------------------------------------------------------------------
void Game_Ocean::sliderMoved(Slider* slider)
{
	using namespace Ogre;
...
//--------------------------------------------------------------------------
void Game_Ocean::changePage(int pageNum /* = -1 : toggle */)
{
...
void Game_Ocean::itemSelected(SelectMenu *menu)
{
...
bool Game_Ocean::frameRenderingQueued(const FrameEvent& evt)
{
...
void Game_Ocean::buttonHit(OgreBites::Button* button)
{
	//Only one button - change page
	changePage();
}

void Game_Ocean::checkBoxToggled(CheckBox* cb)
{
	//Only one checkbox
	mSpinLight = cb->isChecked();
}

#endif	// end _Game_Ocean_H_
