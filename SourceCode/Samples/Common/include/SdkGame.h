...
| Note       : ....................................                                
---------------------------------------------------------------------------------------
| Create File: 21:30:44 15/10/2016 by bahao                                                             
---------------------------------------------------------------------------------------
| Last Update: 21:30:44 15/10/2016 by bahao                                                             
---------------------------------------------------------------------------------------
*/
#ifndef __SdkGame_H__
#define __SdkGame_H__
...
{
	/*=============================================================================
	// Base SDK Game class. Includes default player camera and SDK trays.
	=============================================================================*/
	class SdkGame : public Game, public SdkTrayListener
    {
	public:
		SdkGame()
		{
		...
		virtual void _setup(Ogre::RenderWindow* window, InputContext inputContext, Ogre::FileSystemLayer* fsLayer, Ogre::OverlaySystem* overlaySys)
		{
			...
			mTrayMgr = new SdkTrayManager("GameControls", window, inputContext, this);  // create a tray interface
			...
			// create a params panel for displaying Game details
		...
		virtual void _shutdown()
		{
			...
			// restore settings we may have changed, so as not to affect other Games
    ...
    protected:
		...
		ParamsPanel* mDetailsPanel;   		// Game details panel
