...
---------------------------------------------------------------------------------------
| Filename   : DeferredShadingDemo.h                                                           
---------------------------------------------------------------------------------------
| Written in : C++                                                     
---------------------------------------------------------------------------------------
...
| Note       : ....................................                                
---------------------------------------------------------------------------------------
| Create File: 21:35:09 15/10/2016 by bahao                                                             
---------------------------------------------------------------------------------------
| Last Update: 21:35:09 15/10/2016 by bahao                                                             
---------------------------------------------------------------------------------------
*/
...
class _OgreGameClassExport Game_DeferredShading : public SdkGame, public RenderTargetListener
{
protected:
...
protected:
	...
	{
		if( SdkGame::frameRenderingQueued(evt) == false )
			return false;
	...
	void createKnotScene(SceneNode* rootNode)
	{
        ...
        for (int i=0; i < 5; i++)
        {
            ...
            knotLight->setDiffuseColour(Game_COLORS[i]);
    ...
    void testCapabilities(const RenderSystemCapabilities* caps)
    {
			...
			!GpuProgramManager::getSingleton().isSyntaxSupported("glsl150"))
        {
			OGRE_EXCEPT(Exception::ERR_NOT_IMPLEMENTED, "Your graphics card does not support advanced vertex"
                        " programs, so you cannot run this Game. Sorry!", "DeferredShading::testCapabilities");
        }
    }
